...
`scNet` is a R package with collection of single cell RNA-sequencing (scRNA-seq) data analysis functions developed by team of <a href = "http://www.maths.usyd.edu.au/u/SMS/bioinformatics/">**Sydney Precision Bioinformatics Research Group**</a> at The University of Sydney.
...
```r
devtools::install_github("taiyunkim/scNet", build_opts = c("--no-resave-data", "--no-manual"))
library(scNet)
```
...
```r
devtools::install_github("taiyunkim/scNet", build_vignettes = TRUE)
library(scNet)
```
...
```r
devtools::install_github("taiyunkim/scNet")
library(scNet)
```
...
* **scClust**: Kim, T., Chen, I., Lin, Y., Wang, A., Yang, J., & Yang, P.† (2018) Impact of similarity metrics on single-cell RNA-seq data clustering. ***Briefings in Bioinformatics*** <a href="https://doi.org/10.1093/bib/bby076">[https://doi.org/10.1093/bib/bby076]</a>


* **scReClassify**: Kim, T., Lo, K., Geddes, T., Kim, H., Yang, J., & Yang, P.† (2018) scReClassify: post hoc cell type classification of single-cell RNA-seq data. under consideration.
