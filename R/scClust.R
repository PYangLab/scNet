...
#' @param method Clustering method to be performed on the dataset between "`simlr`" implemented version of SIMLR or "`kmeans`" from \emph{amap} package. It is set to "`simlr`" by default.
#' @param similarity A similarity metric to be used for clustering. This must be one of "`euclidean`", "`pearson`" or "`spearman`". If `kmeans` is chosen for method, "`manhattan`" and "`maximum`" distances are also available.
...
#' @param ... an additional parameters for corresponding clustering method specified from `method`
#'
